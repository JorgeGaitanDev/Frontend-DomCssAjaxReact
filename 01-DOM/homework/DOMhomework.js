...
span.innerHTML = span.innerHTML + " Jorge Gaitan"; //Ponemos el nombre de quien realizo la app
...
ToDo.prototype.completeToDo = function () {
 ...
 //sirve para poder seleccion con negrilla y viceversa:
 // this.complete = true;
};
